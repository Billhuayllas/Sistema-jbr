...
from modules.terceros.routes import terceros_bp # Import the new terceros blueprint
...
app.register_blueprint(terceros_bp) # Register terceros blueprint (prefix is /terceros as defined in its Blueprint)
